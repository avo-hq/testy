...
t = FactoryBot.build(:post)
puts ["tttt->", t, Faker::App.name].inspect
...
teams = []
teams.push(FactoryBot.create(:team, name: "Apple", url: "https://apple.com", color: "#666666"))
teams.push(FactoryBot.create(:team, name: "Google", url: "https://google.com", color: "#0561E0"))
teams.push(FactoryBot.create(:team, name: "Facebook", url: "https://facebook.com", color: "#4185F5"))
teams.push(FactoryBot.create(:team, name: "Amazon", url: "https://amazon.com", color: "#F56600"))
...
reviews.each do |review|
  ...
  puts ["reviewable->", reviewable].inspect
