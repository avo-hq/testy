...
FactoryBot.define do
  ...
  factory :post do
    add_attribute(:name) { Faker::Quote.famous_last_words }
  ...
  factory :project do
    add_attribute(:name) { Faker::App.name }
  ...
  factory :person do
    add_attribute(:name) { "#{Faker::Name.first_name} #{Faker::Name.last_name}" }
  end
  ...
  factory :fish do
    add_attribute(:name) { %w[Tilapia Salmon Trout Catfish Pangasius Carp].sample }
  end

  factory :course do
    add_attribute(:name) { Faker::Educator.unique.course_name }
  ...
  factory :city do
    add_attribute(:name) { Faker::Address.city }
