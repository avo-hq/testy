...
RSpec.feature "SkipShowView", type: :system do
  ...
  describe "skip_show_view = true" do
    ...
    it "create and delete association redirects to the edit page" do
      ...
      # Delete
      visit "/admin/resources/course_links/#{course.links.first.id}/edit?via_resource_class=Avo::Resources::Course&via_record_id=#{course.id}"
  ...
  describe "skip_show_view = false" do
    ...
    it "create and delete association redirects to the show page" do
      ...
      visit "/admin/resources/course_links/#{course.links.first.id}?via_resource_class=Avo::Resources::Course&via_record_id=#{course.id}"
