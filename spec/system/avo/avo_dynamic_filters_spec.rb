...
RSpec.describe "DynamicFilters", type: :system do
  ...
  describe "with filters bar expanded" do
    around do |example|
      initial_value = AvoFilters.configuration.always_expanded
      AvoFilters.configuration.always_expanded = true
      AvoFilters.configuration.button_label = "Feelters"
      example.run
      AvoFilters.configuration.always_expanded = initial_value
    end
  ...
  describe "with filters bar collapsed" do
    around do |example|
      initial_value = AvoFilters.configuration.always_expanded
      AvoFilters.configuration.always_expanded = false
      AvoFilters.configuration.button_label = "Feelters"
      example.run
      AvoFilters.configuration.always_expanded = initial_value
    end
