...
require "rspec/autorun" if ENV["RECORD_TIMES"] == "1"
...
RSpec.configure do |config|
  ...
  config.include TestHelpers::FilterHelpers
  config.include TestHelpers::AvoHelpers
  ...
  config.example_status_persistence_file_path = "spec_times.txt"
end
