  ...
  describe ".index" do
    ...
    context "when user is not admin" do
      ...
      it "returns the scoped results" do
        ...
        resource_ids = assigns(:records).collect { |i| i.id }
    ...
    describe "with via_resource_name" do
      subject { get :index, params: {via_resource_name: "projects", via_record_id: project.id, via_relationship: "users"} }
...
#     describe 'with via_resource_name' do
#       subject { get :index, params: { resource_name: 'users', via_resource_name: 'projects', via_record_id: project.id, via_relationship: 'users' } }
