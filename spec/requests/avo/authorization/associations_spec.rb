  ...
  describe "all false" do
    ...
    describe ".team_members related" do
      it "returns the scoped results" do
        ...
        expect(resource_index).not_to have_selector("[data-controller='toggle actions-picker']")
  ...
  describe "all true" do
    context ".index" do
      it "returns the scoped results" do
        ...
        resource_index = find('[data-component="resources-index"]')
        expect(resource_index).to have_selector("[data-controller='toggle actions-picker']")
